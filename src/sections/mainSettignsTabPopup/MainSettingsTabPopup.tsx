...
const options = [/* 'Notifications & Permissions', */ 'My Profile', 'Log out'];
...
export default function MainSettingsTabPopup({
  onSelect,
}: {
  ...
  return (
    <DropdownMenuContent
      className={`ml-50 mb-2 bg-white min-w-[200px] border-none ${OpenSans400.className}`}
      style={{
