...
const DesignFilesPreview: React.FC = () => (
    <div className="flex flex-col bg-white h-[calc(100%-65px)] min-w-[340px] w-[40%] max-w-[500px] border-r border-[#E8E8E8] relative justify-center">
        <span className="ml-2.5 mt-4 text-sm font-semibold text-black">Design Files</span>
